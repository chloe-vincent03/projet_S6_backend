  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        ...
        _push(`<span>S&#39;inscrire</span>`);
      }
      _push(`</button><p class="text-sm text-gray-600"> Déjà un compte ? `);
...
//# sourceMappingURL=register-AuAJXnAk.mjs.map
