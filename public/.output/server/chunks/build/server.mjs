...
const _routes = [
  {
    name: "map",
    path: "/map",
    component: () => import('./map-Dsqdoej3.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BUJB4oVd.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-Baq0DTuO.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-BXP6WyKC.mjs')
  },
  {
    name: "addlieux",
    path: "/addlieux",
    component: () => import('./addlieux-B07UwBdp.mjs')
  },
  {
    name: "grimoire",
    path: "/grimoire",
    component: () => import('./grimoire-DgR_c8Fy.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-AuAJXnAk.mjs')
  },
  {
    name: "discovery-id",
    path: "/discovery/:id()",
    component: () => import('./_id_-Cul2cr-i.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-4h5SQktB.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BiUE3GCb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CLnTuTeu.mjs'));
...
export { _export_sfc as _, useRouter as a, useRoute as b, useRuntimeConfig as c, __nuxt_component_0$1 as d, entry_default as default, asyncDataDefaults as e, createError as f, fetchDefaults as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
